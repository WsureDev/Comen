...
import { MessageInterface, MESSAGE_INTERFACE } from '@comen/player';
...
@Component({
    selector: 'comen-player',
    template: `<bv-player-render></bv-player-render>`,
    viewProviders: [{
        provide: MESSAGE_INTERFACE,
        useExisting: BvPlayerPage
    },RxZone]
})

// eslint-disable-next-line @angular-eslint/component-class-suffix
export class BvPlayerPage implements MessageInterface, OnDestroy, AfterViewInit {
